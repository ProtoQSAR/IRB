...
def ICk(mol, **kwargs):
    ...
    0-5-ordered neighborhood information content
    '''
    calc = Calculator(
...
def tICk(mol, **kwargs):
    '''
    0-5-ordered neighborhood total information content. TIC in mordred
    '''
    calc = Calculator(
...
def SICk(mol, **kwargs):
    '''
    0-5-ordered structural information content
    '''
...
def BICk(mol, **kwargs):
    '''
    0-5-ordered bonding information content
    '''
    calc = Calculator(
...
def CICk(mol, **kwargs):
    ...
    0-5-ordered complementary information content
    '''
    calc = Calculator(
...
def MICk(mol, **kwargs):
    '''
    0-5-ordered modified information content
    '''
    calc = Calculator(
...
def ZMICk(mol, **kwargs):
    '''
    0-5-ordered Z-modified information content
    '''
    calc = Calculator(
