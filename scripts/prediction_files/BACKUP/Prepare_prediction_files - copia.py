...
config_file_files = 'config_prepare_predictions_files.xlsx'
config_file_tools = 'config_prepare_predictions_tools.xlsx'
...
df_tools_enpoints = pd.read_excel(config_file_tools, sheet_name = 'properties_by_tools', header = 1)
...
for dataset, info in config_df.iterrows():
    ...
    df = read_file(file, separator, encoding)
